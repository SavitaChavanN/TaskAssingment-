...
public class Senario4 extends BaseClass{
	public Senario4(WebDriver driver) throws IOException {
	     this.driver=driver;
...
//		-------------------------------------------------
		...
		public void enterCredentials()
		{
			...
			user_name.sendKeys(prop.getProperty("username4"));
			...
			System.out.println("Bike Light  added to cart ,Keep shopping");
			
			tshirt_addtocart.click();
			System.out.println("T-shirt added to cart,Keep Shopping");
